      ...
      <section className="mt-6 bg-[var(--color-muted)] rounded-xl p-5 text-sm space-y-4">
        ...
        <div>
          ...
          <ul className="space-y-1 text-[var(--color-muted-foreground)] list-disc ps-5">
            <li>
              במצב <b>עדכון בלבד</b> (מומלץ) כל שורה מותאמת לתלמיד קיים לפי
              קוד אישי (או שם ייחודי) והשדות שבקובץ מתעדכנים —{" "}
              <b>בלי למחוק</b> תשלומים, מיטות, חדרים או שיוכי נדרים. שדה שריק
              בקובץ לא ידרוס ערך שכבר קיים.
            </li>
            <li>
