 ...
 * keys. שלוחה 5's cancellation report is now the same weekly ApprovalAll.YYYY-WW
 * file as the bookings, so a cancellation row's weekKey lines up directly with
 * the booking's — a plain (personalCode, weekKey) match voids it.
 */
