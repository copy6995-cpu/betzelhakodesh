...
`Start-Betzel.bat` בונה אוטומטית את הגרסה האחרונה בכל הפעלה ומפנה את
הפורט אם שרת ישן עדיין רץ — כך שלחיצה כפולה עליו תמיד מריצה את הקוד
העדכני. אחרי שינוי קוד פשוט הפעילו אותו מחדש (הבנייה לוקחת 15-30 שניות).
